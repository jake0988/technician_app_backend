...
# byebug
d = Piano.new(make: "Steinway", model: "B", serial: "09124WFEW", year: 2000, image: "https://steinwaypianodb.imgix.net/584537/ABubinga1.jpg?&w=1080&h=auto", future_work: "YIKES!")

e = Piano.new(make: "Boston", serial: "lkjans42", year: 2003, image: "https://cdn.shopify.com/s/files/1/0050/7160/1782/products/IMG_3024-1_compact.jpg?v=1614120053", future_work: "uggh, craigslist")

f = Piano.new(make: "Mason & Hamlin", model: "BB", serial: "lkSFns42", year: 1949, image: "https://www.jimlaabsmusicstore.com/wp-content/uploads/2019/06/Mason-Hamlin-BB.jpeg", future_work: "surpisingly musical")

g = Piano.new(make: "Boston", serial: "lkjans42", year: 1993, image: "https://i.ebayimg.com/images/g/kAsAAOSwKtlWq~YX/s-l1600.jpg", future_work: "none too shabby!")
a.pianos << d
b.pianos << e
c.pianos << f
a.pianos << g